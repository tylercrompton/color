...
class Color:
	...
	three-item indexable object (i.e. tuple, list, etc.)
...
"""
	...
	def __repr__(self):
		return '{}({})'.format(self.__class__.__name__, (self.red, self.green, self.blue))

	@property
	def hex(self):
		return '#{:02x}{:02x}{:02x}'.format(round(self.red), round(self.green), round(self.blue))
